...
pos_y02 = 700     # posição y do carro 02

pos_x03 = 355    # posição x do carro 03
pos_y03 = 700    # posição y do carro 03
...
velocidade02 = 10   #velocidade dos demais carros
...
while janela_aberta:
    ...
    if (pos_y02 <= -180):
        pos_y02 = randint(800,1000)
        print('Carro Azul',pos_y02)
    if (pos_y03 <= -180):
        pos_y03 = randint(1300,2000 )
        print('carro vermelho',pos_y03)
    if (pos_y04 <= -180):
        pos_y04 = randint(2300,3000)
    ...
    pos_y03 -= velocidade02  #+ 10
    pos_y04 -= velocidade02 # + 2
